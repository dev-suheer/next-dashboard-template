...
export function TodaysTasks() {
  const tasksSearchQuery = useDashboardStore((s) => s.tasksSearchQuery);
  const setTasksSearchQuery = useDashboardStore((s) => s.setTasksSearchQuery);
  const tasksProjectFilter = useDashboardStore((s) => s.tasksProjectFilter);
  const toggleTasksProjectFilter = useDashboardStore(
    (s) => s.toggleTasksProjectFilter
  );
  const setTasksProjectFilter = useDashboardStore(
    (s) => s.setTasksProjectFilter
  );
